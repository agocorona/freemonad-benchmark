...
/* package free-vl-0.1.3 */
#define VERSION_free_vl "0.1.3"
#define MIN_VERSION_free_vl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package transient-0.1.1 */
#define VERSION_transient "0.1.1"
...
#define CURRENT_PACKAGE_KEY "freem_7JK7Hrfk5VEJu29YyFbtnK"
